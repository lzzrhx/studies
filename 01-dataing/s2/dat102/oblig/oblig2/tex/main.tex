...
// Konklusjon: Da vi testet den opprinnelige algoritmen sammenlignet med den modifiserte, observerte vi at kjøretiden ble betydelig redusert etter endring i algoritmen.
...
Vi legger en ny type kvikksortering (med "Lomuto partition scheme") til i SortInt klassen:
...
public class SortInt {
    ...
    // Quick, Lomuto partition scheme (Kvikksortering) - Best: n log n / Avg: n log n / Worst: n^2 / Mem: log n / Stable: No / In-place: Yes / Method: Partitioning / Parallel: ?
