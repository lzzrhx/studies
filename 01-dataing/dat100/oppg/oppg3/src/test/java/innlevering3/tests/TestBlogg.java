...
public class TestBlogg {
    ...
    public void testStandardConstructor() {
        ...
        assertEquals(samling.antall(), 0);
        assertEquals(samling.samling().length, 20);
    }
    ...
    public void testConstructor() {
        ...
        assertEquals(samling.antall(), 0);
        assertEquals(samling.samling().length, 40);
    }
    ...
    public void testleggTil() {
        ...
        TInnlegg innlegg3 = new TInnlegg(4, "Oda Olsen", "24-10");
        assertTrue(samling.leggTil(innlegg1));
        assertTrue(samling.leggTil(innlegg2));
        assertEquals(samling.antall(),2);
        assertTrue(samling.finn(innlegg1) >= 0);
        assertTrue(samling.finn(innlegg3) < 0);
    ...
    public void testledigPlass() {
        ...
        assertTrue(samling1.ledig());
        assertFalse(samling2.ledig());
    }
    ...
    public void testutvid() {
        ...
        assertEquals(samling.antall(), 2);
        assertFalse(samling.ledig());
        samling.utvid();
        assertTrue(samling.finnes(innlegg1));
        assertTrue(samling.finnes(innlegg2));
        assertEquals(samling.antall(), 2);
        assertTrue(samling.ledig());
    }
    ...
    public void testslett() {
        ...
        samling.leggTil(innlegg1);
        samling.leggTil(innlegg2);
        assertEquals(2, samling.antall());
        assertTrue(samling.finnes(innlegg1));
        assertTrue(samling.finnes(innlegg2));
        samling.slett(innlegg2);
        assertEquals(1, samling.antall());
        assertTrue(samling.finnes(innlegg1));
