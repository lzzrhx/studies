...
public class Draw3 {
    ...
    // Enkelt skip
    /*
    public static void shipAlt(float size, Matrix matrix, Color color) {
        Vector3[] points = new Vector3[10];
        points[0] = Vector3Transform(new Vector3().x(-size * 0.2f).z(-size * 1.5f), matrix);
        points[5] = Vector3Transform(new Vector3().x(size * 0.2f).z(-size * 1.5f), matrix);
        points[1] = Vector3Transform(new Vector3().x(-size).z(size), matrix);
        points[6] = Vector3Transform(new Vector3().x(-size * 0.6f).y(size / 4f).z(size * 0.2f), matrix);
        points[7] = Vector3Transform(new Vector3().x(-size * 0.75f).y(size / 4f).z(size), matrix);
        points[2] = Vector3Transform(new Vector3().x(size).z(size), matrix);
        points[8] = Vector3Transform(new Vector3().x(size * 0.6f).y(size / 4f).z(size * 0.2f), matrix);
        points[9] = Vector3Transform(new Vector3().x(size * 0.75f).y(size / 4f).z(size), matrix);
        points[3] = Vector3Transform(new Vector3().y(size / 2f).z(size), matrix);
        points[4] = Vector3Transform(new Vector3().y(size / 3f).z(-size * 0.25f), matrix);
        DrawLine3D(points[0], points[1], color);
        DrawLine3D(points[5], points[2], color);
        DrawLine3D(points[0], points[5], color);
        DrawLine3D(points[1], points[2], color);
        DrawLine3D(points[7], points[3], color);
        DrawLine3D(points[2], points[9], color);
        DrawLine3D(points[9], points[3], color);
        DrawLine3D(points[0], points[4], color);
        DrawLine3D(points[5], points[4], color);
        DrawLine3D(points[3], points[4], color);
        DrawLine3D(points[6], points[4], color);
        DrawLine3D(points[2], points[8], color);
        DrawLine3D(points[8], points[4], color);
        DrawLine3D(points[8], points[5], color);
        DrawLine3D(points[8], points[9], color);
        DrawLine3D(points[6], points[1], color);
        DrawLine3D(points[6], points[0], color);
        DrawLine3D(points[7], points[1], color);
        DrawLine3D(points[7], points[6], color);
    }
    */
