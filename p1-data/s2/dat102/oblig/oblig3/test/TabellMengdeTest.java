...
public class TabellMengdeTest {
    @Test
    void test() {
        MengdeADT<Integer> a = new TabellMengde<Integer>();
        assertTrue(a.erTom());
        a.leggTil(1);
        a.leggTil(1);
        a.leggTil(2);
        ...
        MengdeADT<Integer> b = new TabellMengde<Integer>();
        b.leggTil(3);
        b.leggTil(4);
        b.leggTil(5);
        b.leggTil(5);
        ...
        MengdeADT<Integer> c = new TabellMengde<Integer>();
        c.leggTilAlleFra(a);
        c.fjern(3);
        ...
        MengdeADT<Integer> d = new TabellMengde<Integer>();
        d.leggTilAlleFra(c);
