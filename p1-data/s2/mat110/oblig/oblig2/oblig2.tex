...
\usepackage[fleqn]{mathtools}     % Improvements for math
...
\setmonofont{PxPlus ToshibaSat 8x16}[AutoFakeBold,AutoFakeSlant] % Override monospace font
...
\usepackage{witharrows}           % Add arrows to equations
...
\newcommand{\emne}{MAT110}
\newcommand{\tittel}{Obligatorisk innlevering 2}
\newcommand{\forfatter}{Stephen Neba Fuh, \ Ebubekir Siddik Yuksel,\\ Casper Eide Özdemir-Børretzen}
\newcommand{\dato}{17. april 2026}
...
\settoggle{endnotes}{false} % Konverter fotnoter til endenoter
...
\fancyfoot[C]{\footnotesize\textbf{\thepage} \tiny\textbf{ / } \footnotesize\textbf{9}}
