...
\newcommand{\dato}{21. februar 2026}
...
\subsection*{Abstract}
A thesis from a Norwegian University should contain abstracts in both Norwegian and English irrespectively of the thesis language

%\chapter*{Dedication}
%If you wish to dedicate the thesis to someone you may add a separate page with a dedication here.

%\chapter*{Acknowledgements}
%If there is someone who deserves a 'thank you', you may add acknowledgements here.
...
The introduction of the thesis should take the reader all the way
from the big picture and context of the project to the concrete task that has
been solved in the thesis.
